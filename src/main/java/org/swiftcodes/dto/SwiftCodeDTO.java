...
public class SwiftCodeDTO {
    ...
    public Map<String, Object> toHashMap() throws JsonProcessingException {
        ...
        swiftCodeHashMap.put("address", bankAddress);
    ...
    public Country getCountryData(){
        return new Country(countryISO2, countryName);
    }

    public Bank getBankData(int countryId){
        return new Bank(isHeadquarter, bankName, bankAddress, countryId);
    }

    public SwiftCode getSwiftCodeData(int bankId){
        return new SwiftCode(swiftCode, bankId);
    }
